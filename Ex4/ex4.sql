leREM ASSIGNMENT 4:Views – Security
...
REM Update
UPDATE Schedule_15
SET Ddate='15-APR-05',Dtime=1000,Adate='20-MAR-23',Atime=1050
WHERE Flight='HA-1';
...
REM Conclusion
REM INSERT - NO
REM UPDATE - YES(Can update ddate,dtime,adate,atime and is reflected in parent table)
REM DELETE - YES(deleted in parent table)
...
REM Conclusion
REM INSERT - YES
REM UPDATE - YES(reflected in the parent table)
REM DELETE - NO
